...
export default class ApiError extends Error{
    ...
    static UnauthorizedError(){
        return new ApiError(401,"Пользователь не авторизован"); // возвращаем экземпляр этого класса ApiError,то есть создаем объект на основе этого класса,куда передаем параметры status код ошибки и сообщение ошибки
    }
