...
const Catalog = () => {
    ...
    useEffect(() => {
        ...
        // можно считать максимальную цену из всех товаров тут,но можно и делать это на сервере,а просто потом с фронтенда делать запрос на сервер,для получения максимальной цены товара из всех,просто если делать это так,как мы сделали,то состояние numberMass(массив чисел всех цен товаров) будет всегда пополняться и не очищаться,но уже сделали так
